...
actx branch batch-1 "items 1-5"
actx branch batch-2 "items 6-10"

# After all complete, merge branches:
actx merge batch-1 "findings from items 1-5"
actx merge batch-2 "findings from items 6-10"
actx commit "consolidated all research"
```
